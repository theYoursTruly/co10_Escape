...
private _backPack = call compile format["[A3E_StartPos, %1] call %2;",_fenceRotateDir,selectRandom ["a3e_fnc_BuildPrison","a3e_fnc_BuildPrison2","a3e_fnc_BuildPrison3"]];
